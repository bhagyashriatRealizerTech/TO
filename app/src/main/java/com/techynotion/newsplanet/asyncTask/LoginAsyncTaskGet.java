...
public class LoginAsyncTaskGet extends AsyncTask<Void, Void,StringBuilder>
{
    ...
    public LoginAsyncTaskGet(RegistrationModel registrationModel, Context myContext, OnTaskCompleted cb)
    {
    ...
    protected StringBuilder doInBackground(Void... params) {
        ...
        String registerUrl= Utils.URL+"AuthenticateUser";
